...
import fourever.textile.customsearch.utils.Util;
...
public class MaterialSearchView extends FrameLayout implements View.OnClickListener, onSearchActionsListener {
    ...
    @Override
    public void Dialog_progressBar(boolean show) {
        if (show) {
            Dialog_progressBar.setVisibility(VISIBLE);
        } else {
            Dialog_progressBar.setVisibility(GONE);
        }
    }
    ...
    public MaterialSearchView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        mFrameLayout = (RecyclerView) findViewById(R.id.material_search_container);
    ...
    public void onQuery(String query) {
        ...
        if (searchViewResults != null) {
            ...
            searchViewResults.setListView(mFrameLayout,trim, "searchQuery");
            searchViewResults.setSearchProvidersListener(this);
        } else {
            searchViewResults = new SearchViewResults(mContext, trim, mFrameLayout);
            searchViewResults.setSearchProvidersListener(this);
            searchViewResults.setListView(mFrameLayout,trim, "searchQuery");
        }
    }

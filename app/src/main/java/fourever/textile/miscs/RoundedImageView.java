...
public class RoundedImageView extends NetworkImageView {
    ...
    private void setup() {
        ...
        setBorderColor(ContextCompat.getColor(context, R.color.accentcolor));
        paintBorder.setAntiAlias(true);
        this.setLayerType(LAYER_TYPE_SOFTWARE, paintBorder);
        paintBorder.setShadowLayer(4.0f, 0.0f, 2.0f, ContextCompat.getColor(context, R.color.accentcolor));
    }

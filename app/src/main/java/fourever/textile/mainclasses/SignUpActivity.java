        ...
        btnregister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!TextUtils.isEmpty(unm.trim()) && !TextUtils.isEmpty(add.trim()) &&
                    ...
                    !TextUtils.isEmpty(pass.trim()) && !TextUtils.isEmpty(btitle.trim()) &&
                        !TextUtils.isEmpty(bdesc.trim())) {
                    ...
                    if(emailcheck == true && mobilecheck == true ){
                        if(!getcityid.equals("0")){
                            new SaveServiceSync().execute(unm, emailid, cnno, add, pass, btitle, bdesc, profile_pic, getcityid, fb_login, regid);
                        }else{
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected void onPostExecute(String result) {
                ...
                if (regid == null || regid.equals(null) || regid.equals("null")
                        || regid.equals("")) {
                    salert.showAlertDialog(SignUpActivity.this, "Error",
            ...
            try {
                ...
                for (int i = 0; i < jArray.length(); i++) {
                    ...
                    ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(
                            SignUpActivity.this, R.layout.spinneritem, list1);
                    dataAdapter
    ...
    public class SaveServiceSync extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                objClient.setParam("address", params[3]);
                objClient.setParam("password", params[4]);
                objClient.setParam("short_desc", params[5]);
                objClient.setParam("long_desc", params[6]);
                objClient.setParam("profile_pic", params[7]);
                objClient.setParam("city_id", params[8]);
                objClient.setParam("fb_login", params[9]);
                objClient.setParam("device_id", params[10]);
                Response = objClient.postData("http://4eversolutions.co.in/projects/TextileApp/webservice/user_add.php");
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        protected void onPostExecute(String res) {
            try {
                if (res == null || res.equals("")) {
                    mProgressDialog.dismiss();
                    salert.showAlertDialog(SignUpActivity.this, "Registration",
                        ...
                        for (int i = 0; i < jArray.length(); i++) {
                            ...
                            if (errorcode.equals("0")) {
                               ...
                               /* FragmentManager frgManager = getActivity().getSupportFragmentManager();
                                ...
                                customtoast.ShowToast(SignUpActivity.this,"This email is already registered.", R.layout.red_toast);
                            }
                        }
                    }
                }
                        ...
                        for (int i = 0; i < jArray.length(); i++) {
                            ...
                            if (errorcode.equals("0")) {
                               ...
                               /* FragmentManager frgManager = getActivity().getSupportFragmentManager();
                                ...
                                // Toast.makeText(getActivity(), json.getString("errormsg"), Toast.LENGTH_LONG).show();
                                customtoast.ShowToast(SignUpActivity.this, json.getString("errormsg"), R.layout.red_toast);
                            }
                        }
                    }
                }

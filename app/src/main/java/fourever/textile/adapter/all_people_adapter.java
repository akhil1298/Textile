 ...
 */
public class all_people_adapter extends RecyclerView.Adapter<all_people_adapter.ViewHolder> {
    ...
    public all_people_adapter(Context c, List<all_people_entity> people) {
        mContext = c;
        this.people = people;
    ...
    @Override
    public void onBindViewHolder(final all_people_adapter.ViewHolder holder, int position) {
      //  animate(holder);
